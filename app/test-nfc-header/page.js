...
export default function TestNfcHeader() {
  return (
    <div className="page-root">
      ...
      <div className="header-wrap">
        ...
        {/* RIGHT: The animation with decorative elements */}
      ...
      <div className="scene">
        ...
        {/* NFC Card that slides in slowly from the left, tucks behind the top of the phone — REAL SmartProfile card (golden CopperKing branding) */}
        ...
        <div className="phone">
          ...
          <div className="phone-screen">
            ...
            {/* Default wallpaper / lock screen — visible before tap, fades out on tap */}
            ...
            {/* Profile card that slides up on tap — covers full screen — REAL customer: CopperKing */}
          ...
          {/* Tap glow ring, sits above the phone near the top */}
      ...
      <style jsx>{`
        ...
        @media (max-width: 760px) {
          .header-wrap { flex-direction: column-reverse; text-align: center; }
          .header-text { max-width: 100%; align-items: center; }
        ...
        /* ---------- PROFILE CARD (slides up on tap, covers full screen) ---------- */
        .profile-card {
          position: absolute;
          inset: 0;
          z-index: 2;
        ...
        /*
          Profile stays hidden while card is arriving/holding.
          Starts sliding up only once the card has fully settled (touched).
        */
        @keyframes slideUp {
        ...
        /* ---------- TAP GLOW (fires exactly when card touches, before profile appears) ---------- */
        .tap-glow {
          position: absolute;
          top: 30px;
          left: 60px;
        ...
        /* ---------- NFC CARD (real image, credit-card proportions) ---------- */
        .nfc-card {
          position: absolute;
          top: -14px;
          left: 0;
        ...
        /*
          Sequence (8s loop, calm pacing):
          0-6%    card off-screen, invisible
          6-27%   STEP 1: card slowly, calmly slides in and settles touching the phone (21% span = ~1.7s, gentle)
          27-38%  card HOLDS touching → glow fires (31-38%)
          38-52%  screen still shows card touching; lock screen fades out
          52-64%  STEP 2: profile slides up into view (card is still touching throughout this)
          64-78%  STEP 3: now that profile is visible, card slowly retreats back off-screen
          78-88%  profile stays visible alone, card fully gone
          88-96%  profile slides back down, lock screen returns
          96-100% reset pause
        */
        @keyframes nfcTap {

...
export default function HomePage() {
  ...
  return (
    <div style={{ fontFamily: "'Inter', -apple-system, sans-serif", color: '#1e293b', overflowX: 'hidden' }}>
      ...
      {/* HERO */}
      <section className="hero-section" style={{ background: 'linear-gradient(120deg, #f8fafc 0%, #eff6ff 45%, #1e3a8a 45%, #1d4ed8 100%)', minHeight: '92vh', display: 'flex', alignItems: 'center', padding: '60px 24px', position: 'relative', overflow: 'hidden' }}>

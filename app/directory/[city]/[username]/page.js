                    ...
                    <div className="flex gap-4">
                      {socials.map((s) => (
                        <a key={s.id} href={s.url} target="_blank" rel="noreferrer" className="flex flex-col items-center gap-1">
                          <div className="w-11 h-11 rounded-full flex items-center justify-center shadow" style={{ backgroundColor: socialColors[s.platform?.toLowerCase()] || "#666" }}>
...
export default function DirectoryListingPage({ params }) {
